...
from utils2 import PMMagnetization2D, DerivedQuantities2D, MagneticField2D, update_current_density
...
def solve_pmsm(outdir: Path = Path("results"), plot: bool = False, progress: bool = False, save_output: bool = False):
    ...
    mexp.mag = msource_mag   # Coercivity
    ...
    mag_term = (mu_0*mu_0/1.04457) * ufl.dot( Mz , curl_vz) * dx(Omega_pm)
    L += mag_term
